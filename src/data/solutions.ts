...
export const SOLUTIONS: Solution[] = [
  ...
  },
  {
    ...
    status: 'Recorded surveys · Coverage dependent',
    statusDetail: 'Explore a real LiDAR dataset in the website demo. WaterWayz also supports recorded survey imagery where a survey has been prepared and made available for that marina. Automated survey analysis and live occupancy remain in development.',
    steps: [
      ...
      { title: 'Connect the useful detail', body: 'Where a recorded survey is available, switch between imagery and the survey on supported marina maps. The survey adds a view of the site at the time it was flown; berth limits and approach records remain separate information.' },
    ],
    currentTitle: 'What you can explore here',
    current: ['An interactive viewer using real aerial LiDAR survey data', 'Height, intensity and derived structure views', 'A sample marina page that explains the source and limits of its demonstration data', 'Recorded survey imagery on supported marina maps, where the survey bundle is available'],
